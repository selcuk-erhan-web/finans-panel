...
const { executiveAuditSummaryHtml } = require("./auditDashboard");
...
function auditLogsPageHtml({ summary, records, filters, executiveDashboard = null }) {
  ...
  return `<div class="dash page-enter dash--dense aud1-hub">
    <header class="aud1-hub__header fade-in">
      ...
      <p class="aud1-hub__desc">Alan bazlı değişimler — formatlanmış önce/sonra görünümü ile. <a href="/audit-analytics">Denetim Analitiği →</a></p>
      ${entityFilterNote}
    </header>

    ${executiveDashboard ? executiveAuditSummaryHtml(executiveDashboard) : ""}
