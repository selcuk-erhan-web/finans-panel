...
const { executiveVehicleDashboardCrossLinkHtml } = require("./executiveVehicleDashboard");
const { vehicle360PageHtml } = require("./vehicle360Center");
...
function vehicleCenterPageHtml(bundle) {
  return `${vehicle360PageHtml(bundle)}
    <div class="vehicle-center-legacy-widgets" aria-hidden="true" hidden>
