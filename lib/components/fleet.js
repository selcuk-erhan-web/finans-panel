...
const { vehicleDetailPath } = require("../vehicleRoute");
...
function vehicleCard(v) {
  ...
  return `<a href="${vehicleDetailPath(v)}" class="vehicle-card vehicle-card--${state} vehicle-card--clickable">
...
function fleetCardLarge(v) {
  ...
  return `<a href="${vehicleDetailPath(v)}" class="fleet-card fleet-card--${state} fleet-card--clickable fade-in">
...
function fleetCardFit(v) {
  ...
  return `<a href="${vehicleDetailPath(v)}" class="fleet-card fleet-card--fit fleet-card--${state} fleet-card--clickable fade-in">
    <div class="fleet-card__glow"></div>
