...
function executiveVehicleDashboardPageHtml(payload) {
  ...
  return `<div class="dash page-enter dash--dense evd-hub">
    <header class="evd-hub__header fade-in">
      <p class="evd-hub__eyebrow">Filo · Executive Vehicle Intelligence</p>
      <h2 class="evd-hub__title">Yönetici Araç Zekâsı</h2>
      <p class="evd-hub__desc">VI-1 ile VI-4 modüllerini birleştiren üst düzey filo karar ekranı.</p>
      <div class="evd-hub__links">
