...
function employeesPageHtml({ kpi, employees, costs, vehicles }) {
  ...
  return `<div class="dash page-enter hr-hub">
    ...
    <div class="hr-kpi-row fade-in">
      <article class="hr-kpi"><span>Aktif Personel</span><strong>${kpi.activeEmployees.toLocaleString("tr-TR")}</strong></article>
      <article class="hr-kpi"><span>Bu Ay Personel Maliyeti</span><strong>${money(kpi.monthPersonnelCost)}</strong></article>
      <article class="hr-kpi hr-kpi--ok"><span>Araç Atanmış Personel</span><strong>${kpi.assignedEmployees.toLocaleString("tr-TR")}</strong></article>
      <article class="hr-kpi hr-kpi--warn"><span>Araç Atanmamış Personel</span><strong>${kpi.unassignedEmployees.toLocaleString("tr-TR")}</strong></article>
    </div>
    ...
    <div class="grid2">
      <section class="panel fade-in">
        ...
        <div class="panel__body">
          <form method="POST" action="/employees/add" class="form-grid">
      ...
      <section class="panel fade-in">
        <header class="panel__head"><h2 class="panel__title">Aylık Personel Maliyeti Ekle</h2></header>
        <div class="panel__body">
          <form method="POST" action="/employees/cost/add" class="form-grid">
