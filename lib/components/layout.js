...
const NAV = [...NAV_TOP, ["/expenses", "expense", "Gider Yönetimi"], ...NAV_BOTTOM];
...
<body>
  ...
  <div class="app-frame app-container">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar__nav" aria-label="Ana menü" data-sidebar-nav="expense-navigation-v2">${nav}</nav>
