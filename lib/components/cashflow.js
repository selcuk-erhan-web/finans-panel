...
function cashflowPageHtml({ summary, receivables, obligations, timeline }) {
  ...
  return `<div class="dash page-enter dash--dense cashflow-hub">
    ...
    <div class="cashflow-kpi-row fade-in">
      <article class="cashflow-kpi cashflow-kpi--in${summary.totalExpectedReceivables ? "" : " cashflow-kpi--empty"}">
        <span>Toplam Beklenen Tahsilat</span>
        ${
          summary.totalExpectedReceivables
            ? `<strong class="text-pos">+${money(summary.totalExpectedReceivables)}</strong>`
            : kpiValueHtml(0)
        }
      </article>
      <article class="cashflow-kpi cashflow-kpi--out${summary.totalUpcomingObligations ? "" : " cashflow-kpi--empty"}">
      ...
      <article class="cashflow-kpi cashflow-kpi--net${summary.netExpectedCash ? "" : " cashflow-kpi--empty"}">
        <span>Net Beklenen Nakit</span>
        ${
          summary.netExpectedCash
