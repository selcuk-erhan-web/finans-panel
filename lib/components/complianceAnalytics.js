...
function complianceAnalyticsPageHtml(analytics) {
  ...
  return `<div class="dash page-enter dash--dense compliance-analytics-hub">
    <header class="compliance-analytics-hub__header fade-in">
      ...
      <h2 class="compliance-analytics-hub__title">Compliance Analytics</h2>
