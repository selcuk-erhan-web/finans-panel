...
function createTireChangeRecord(data) {
  ...
  return getTireChangeRecord(info.lastInsertRowid);
}

function updateTireChangeRecord(id, data) {
  ...
  return getTireChangeRecord(id);
}

function deleteTireChangeRecord(id) {
