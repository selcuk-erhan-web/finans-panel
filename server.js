...
const registerRoadmap = require("./routes/roadmap");
const registerV11ReleaseCandidate = require("./routes/v11ReleaseCandidate");
const registerV11Production = require("./routes/v11Production");
const registerVehicleIntelligence = require("./routes/vehicleIntelligence");
const registerVehicleHealth = require("./routes/vehicleHealth");
const registerVehicleTimeline = require("./routes/vehicleTimeline");
const registerVehicleProfitRisk = require("./routes/vehicleProfitRisk");
const registerExecutiveVehicleDashboard = require("./routes/executiveVehicleDashboard");
...
registerRoadmap(app);
registerV11ReleaseCandidate(app);
registerV11Production(app);
registerVehicleIntelligence(app);
registerVehicleHealth(app);
registerVehicleTimeline(app);
registerVehicleProfitRisk(app);
registerExecutiveVehicleDashboard(app);
